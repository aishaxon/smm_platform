...
MIDDLEWARE = [
    ...
    "core.middleware.RoleAccessLogMiddleware",
]

ROOT_URLCONF = "SMM_PLATFORM.urls"
...
WSGI_APPLICATION = "SMM_PLATFORM.wsgi.application"
...
LOGGING = {
    ...
    "loggers": {
        "role_access": {"handlers": ["console"], "level": "INFO"},
    },
}
